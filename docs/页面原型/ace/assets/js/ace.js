...
ace.handle_side_menu = function(a) {
	...
	a("#sidebar-collapse").on(ace.click_event, function() {
		...
		if(!c){
			...
			a("#sidebar").animate({width:"43px"},500);
			a("#sidebar+.main-content").animate({marginLeft:"43px"},500);
		}else{
			a("#sidebar").animate({width:"190px"},500);
			a("#sidebar+.main-content").animate({marginLeft:"190px"},500);
			ace.settings.sidebar_collapsed(!c);
		}
	});
